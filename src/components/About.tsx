...
const About = () => {
  return (
    <section id="about" className="py-20 bg-gradient-to-br from-background via-jewelry-purple-dark/20 to-background relative">
      {/* Background glow */}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mt-16">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 w-24 h-24 glass-purple rounded-full opacity-60 animate-float"></div>
              <div className="absolute -top-6 -right-6 w-16 h-16 glass-purple rounded-full opacity-40 animate-float" style={{animationDelay: '2s'}}></div>
            </div>
          </div>
        </div>
      </div>
